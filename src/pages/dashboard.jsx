...
export default function dashboard() {
    ...
    function getDataStuffs() {
        ...
        .then(res => {
            ...
            const sarprasStuffs = Stuff.filter(stuff => stuff.category === 'Teknisi/Sarpras');
          setSarpras(sarprasStuffs.length);
 
          const HtlStuffs = Stuff.filter(stuff => stuff.category === 'HTL');
          setHtl(HtlStuffs.length);
          
          const KlnStuffs = Stuff.filter(stuff => stuff.category === 'KLN');
    ...
    function getDataUsers() {
     ...
     function getDataLending() {
        ...
        .then(res=> {
            ...
            const groupedData = {};
            data.forEach((entry) => {
                const date = new Date(entry.data_time)
        ...
        <div className="flex flex-wrap justify-center m-10">
                ...
                <div className="p-4 w-1/2">
                    <div className="flex rounded-lg h-full dark:bg-gray-800 bg-teal-400 p-8 flex-col">
                        ...
                        <div className="flex flex-col justify-between flex-grow">
                            <h1 className="text-white dark:text-white text-lg font-medium">{Sarpras}</h1>
                        </div>
                    </div>
                ...
                <div className="p-4 w-1/2">
                    ...
                    <div className="p-4 w-1/2">
                    <div className="flex rounded-lg h-full dark:bg-gray-8 bg-teal-400 p-8 flex-col">
                        <div className="flex items-center mb-3">
                            <div
                                className="w-8 h-8 mr-3 inline-flex items-center justify-center rounded-full dark:bg-indigo-500 bg-indigo-500 text-white flex-shrink-0">
                                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                ...
                <BarChart
                    ...
                    >
                        ...
                        <Tooltip/>
                        <Legend/>
                        <Bar dataKey="totalStuff" fill="#8884d8" activBar={<Rectangle fill="pink" stroke='blue' />} />
